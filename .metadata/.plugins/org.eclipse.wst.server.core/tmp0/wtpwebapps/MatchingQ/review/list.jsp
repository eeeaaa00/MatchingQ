...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
	  ...
	  <h6 align="center">최근강의평</h6>
	  <table class="table table-shopping">
	  <thead>
	  <tr>
	  	<th class="text-center" width="100" height="22">과목명</th>
		<th class="text-center" width="50" height="20">별점</th>
		<th class="text-center" width="350" height="20">총평</th>
	  </tr>
	  </thead>
	  <tbody>
		<c:forEach var="review" items="${reviewList}">
			<tr>
				...
				<c:param name='courseTitle' value='${review.className}' />
				<c:param name='curUserId' value='${curUserId}' />
				<c:param name='classId' value='${review.classId}' />
				</c:url>">
				${review.className}</a>	 
				</td>	
				<td class="td-number" align="center">
				${review.lectureTotal}      
				</td>
				<td class="td-name">
	...
	<form name="form" class="blog-pagination" action="<c:url value='/review/match' />">
        <input type="button" value="추천받기" onClick="recommand('<c:url value='/review/match' />')" class="btn btn-outline-primary">
    </form>
    <br><br>
    </div>
    <br>
