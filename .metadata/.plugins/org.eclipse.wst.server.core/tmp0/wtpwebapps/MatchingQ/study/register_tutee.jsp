...
<header class="blog-header py-4">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <h4 class="blog-header-logo text-dark">튜티 등록</h4>
      </div>
...
<div class="container-fluid">
  <div class="row">
	...
	<form name="form" method="POST" action="<c:url value='/study/tutee/register' />">
	  <table class="table table-shopping">
		<!-- registration form  -->
		    ...
		    <tr height="40">
			<td width="150" align="center" bgcolor="#f1f1f1">희망 성적</td>
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
	    ...
	    <table style="width: 100%">
		  <tr>
			<td align="left">
			<input type="button" class="btn btn-outline-primary" value="등록 후 매칭" onClick="tuteeCreate()"> &nbsp;
			</td>
		  </tr>
	    </table>
	    </form>
