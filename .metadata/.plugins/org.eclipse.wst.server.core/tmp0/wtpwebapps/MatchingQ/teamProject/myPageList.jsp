...
<header class="blog-header py-4">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <h4 class="blog-header-logo text-dark">나의 팀플 게시판</h4>
      </div>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
	  ...
	  <tr>
		...
		<th class="text-center" width="200" height="20">수강학기</th>
		<th class="text-center" width="200" height="20">분반</th>
		<th class="text-center" width="200" height="20">입장</th>
	  </tr>
	  </thead>
	  <tbody>
		<c:if test="${teamProList.size() eq 0}">
			<tr>
				<td colspan="5" bgcolor="FFFFFF" align="center">가입한 팀프로젝트가 없습니다.</td>
			</tr>
		 </c:if>
		<c:forEach var="teamPro" items="${teamProList}">
			<tr>
				...
				<td width="100" align="center" bgcolor="FFFFFF">
				<a href="<c:url value='/teamProject/comment/view'>
