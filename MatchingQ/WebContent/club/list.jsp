...
<header class="blog-header py-4">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <h4 class="blog-header-logo text-dark">동아리 목록</h4>
      </div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap pt-3 pb-2 mb-3">
	  ...
	  <br>   
	  <a class="btn btn-outline-primary" href="<c:url value='/club/register/form' ><c:param name='stuId' value='${curUserId}'/></c:url>">동아리 추가</a>
	  <a class="btn btn-outline-primary" href="<c:url value='/club/matching/form'><c:param name='stuId' value='${curUserId}'/></c:url>">동아리 매칭</a>
	  </div>
	  </div>
	  </main>
</div>
