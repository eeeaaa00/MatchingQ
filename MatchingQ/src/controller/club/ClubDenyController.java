...
public class ClubDenyController implements Controller {
	...
	if (request.getMethod().equals("GET")) {	
		...
		if (UserSessionUtils.isLoginUser(preId, session) ||
			...
			manager.deleteMatching(student_number);
		...
		request.setAttribute("exception", 
				new IllegalStateException("동아리 거절은 관리자와 부장만 가능합니다."));            
	...
	ClubManager manager = ClubManager.getInstance();		
    return "redirect:/club/applyList";
}
}
